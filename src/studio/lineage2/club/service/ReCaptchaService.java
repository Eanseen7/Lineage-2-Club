...
import studio.lineage2.club.other.ErrorCode;
import studio.lineage2.club.other.RecaptchaAuthenticationException;
...
@Component public class ReCaptchaService
{
	...
	@Autowired public ReCaptchaService(RestTemplate restTemplate)
	{
